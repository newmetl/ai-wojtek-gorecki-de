  ...
  return (
    <div className="p-8 max-w-4xl">
      ...
      <div className="bg-surface border border-border rounded-xl p-6">
        <h2 className="text-sm font-medium text-foreground mb-4">Scraping-Status</h2>
        {lastLog ? (
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
              <span className="text-muted">Letzter Lauf</span>
              <span className="text-foreground">{formatDate(lastLog.runAt)}</span>
            </div>
            <div className="flex justify-between">
            ...
            <div className="flex justify-between">
              <span className="text-muted">Neue Einträge</span>
              <span className="text-foreground">{lastLog.itemsNew}</span>
            </div>
          </div>
        ) : (
          <p className="text-muted text-sm">Noch kein Scraping durchgeführt.</p>
        )}
        <p className="text-xs text-muted mt-4">Scraping: Wird in Schritt 5 implementiert.</p>
      </div>
    </div>
  );
}
