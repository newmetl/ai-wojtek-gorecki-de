...
const links = [
  {
    label: "E-Mail",
    value: "wojtek@gorecki.io",
    href: "mailto:wojtek@gorecki.io",
    icon: (
    ...
    <div className="space-y-3">
      {links.map((link) => (
        <a
          ...
          className={`flex items-center gap-4 rounded-xl border p-4 transition-all hover:-translate-y-0.5 ${
            link.highlight
        ...
        >
          <span className={link.highlight ? "text-primary" : "text-muted-foreground"}>
            {link.icon}
          </span>
          <div>
