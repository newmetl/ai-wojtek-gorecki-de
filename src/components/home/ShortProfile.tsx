        ...
        <div className="flex flex-col items-center gap-8 sm:flex-row sm:items-center sm:gap-12 max-w-3xl mx-auto">
          ...
          <div>
            <p className="text-muted-foreground text-base leading-relaxed">
              ...
              {" "}— Product Owner, Web-Entwickler und KI-Enthusiast. Diese Plattform
              ist mein persönliches Labor: Tools und Ressourcen, die ich selbst täglich
              nutze und für Product Owner zugänglich mache.
            </p>
